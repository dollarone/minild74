class Preload extends Phaser.State {
	...
	preload() {
		...
		this.game.load.spritesheet('road_sprites', 'assets/gfx/road.png', 32, 32);
		this.game.load.spritesheet('cars', 'assets/gfx/cars-spritesheet.png', 32, 64);
		...
		this.game.load.tilemap('track1', 'assets/tilemaps/track1.json', null, Phaser.Tilemap.TILED_JSON);
	}
